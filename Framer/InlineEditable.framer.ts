...
import * as lib from "http://127.0.0.1:8000/index.js?a44";

addPropertyControls(lib.InlineEditable, {
  color: {
    title: "color",
...
const RcInlineEditable: React.ComponentType = lib.InlineEditable;
