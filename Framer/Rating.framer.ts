...
import * as lib from "http://127.0.0.1:8000/index.js?sdfcasdasd";

addPropertyControls(lib.Rating, {
  defaultValue: {
    title: "defaultValue",
  ...
  size: {
    title: "size",
    type: ControlType.Enum,
    description: "that is not exist in code, should use jsx in your <RcIcon size={size} />",
    defaultValue: "xlarge",
    options: [
      "xsmall",
      "small",
...
const RcRating: React.ComponentType = lib.Rating;
