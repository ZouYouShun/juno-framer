...
import * as lib from "http://127.0.0.1:8000/index.js?1asdsa";

addPropertyControls(lib.SnackbarContent, {
  type: {
    title: "type",
...
const RcSnackbarContent: React.ComponentType = lib.SnackbarContent;
